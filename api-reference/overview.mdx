...
Incluye búsqueda sobre esta documentación. Las dos consultas de empleados están habilitadas selectivamente como herramientas MCP y conservan la autenticación Bearer definida en OpenAPI; el cliente solicitará el token cuando se intente ejecutar una herramienta protegida. Mintlify no recibe una credencial pública compartida.
